  ...
  return (
    <>
      ...
      <div className={styles.transactions}>
        {days.map((d) => (
          <div className={styles.box} key={d.name}>
            <div className={styles.head}>
              <div className={styles.date}>
                ...
                <h5 className={styles.day}>{d.name}</h5>
              </div>
              <div className={styles.result}>
                ...
                <h5 className={styles.check}>
                  <span className={styles.value}>
                    {formatNumberWithSign(d.categories.reduce((acc, curr) => acc + curr.value, 0))}
                  </span>
            ...
            <div className={styles.list}>
              {d.categories.map((c) => (
                <div className={styles.item} key={c.name}>
          ...
          <div className={styles.box}>
            <div className={styles.head}>
              <div className={styles.date}>
                ...
                <h5 className={styles.day}>{getFormatDay()}</h5>
              </div>
              <div className={styles.result}>
                <div className={styles.icon}>
                  <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h5 className={styles.check}>
                  <span className={styles.value}>
                    {formatNumberWithSign(operations.reduce((acc, curr) => acc + curr.value, 0))}
                  </span>
                  <span className={styles.currenct}>₽</span>
                </h5>
              </div>
