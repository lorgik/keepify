  ...
  return (
    <>
      ...
      <div className={styles.info}>
        <Image src={'/avatar.png'} alt={'avatar'} width={105} height={105} />
      ...
      <div className={styles.banner}>
        <div className={styles.bg}>
          <Image className={styles.coin} src={'/keepy-coin-bg.png'} alt="keepy coin" width={126} height={143} />
          <Image className={styles.coins} src={'/keepy-coins-bg.png'} alt="keepy coins" width={209} height={263} />
        </div>
        <h3 className={styles.title}>Keepify School</h3>
        <h5 className={styles.text}>
          Обменивай свои коины на полезные материалы и скидки на курсы по финансовой грамотности от топовых экспертов
          индустрии
        </h5>
        ...
        <div className={styles.list}>
          <div className={styles.task}>
            <div className={styles.basic}>
              <Image src={'/daily-task-icon.png'} alt={'icon'} width={44} height={44} />
              <h5>
                <span className={styles.title}>Ежедневный бонус</span>
      ...
      <div className={styles.friends}>
        ...
        <div className={styles.list}>
          <div className={styles.friend}>
            <div className={styles.basic}>
              <Image src={'/ainur-avatar.png'} alt={'icon'} width={44} height={44} />
              <h5>
                <span className={styles.name}>Айнур Сибагатуллин</span>
